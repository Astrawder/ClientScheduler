...
/**
 * Controller class for the addAppointment.fxml.
 *
...
public class AddAppointmentController implements Initializable {
    ...
    /**
     * The initialize function for the controller of the addAppointment.fxml.
     * Allows the user to add appointments to the MySQL database.
     *
     * @param url the url
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        generatedID = appointments.get(appointments.size()-1).getID() + 1;
     ...
     * When successful the new appointment is added to the MySQL database.
    ...
    public void onSaveButtonClick() throws SQLException {
        ...
        if(foundStart && foundEnd){
            ...
            if(startTime == null || endTime == null){
                ...
                alert.setContentText("Please make sure the entered date/time is within office hours (8:00 AM - 10:00PM EST) on a weekday and is a future date/time.");
                alert.show();
                return;
            }
            ...
            if(checkOverlappingTimes(startTime, endTime)){
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                ...
                appointmentDAO.addAppointment(new Appointment(ID, title, description, location, type, startTime, endTime, createDate,
                        createdBy, lastUpdate, lastUpdateBy, customerID, userID, contactDAO.getContactID(contact), contact));
     ...
     */
    private boolean checkOverlappingTimes(Timestamp start, Timestamp end) {
        AppointmentDAOImpl appointmentDAO = new AppointmentDAOImpl();
        ArrayList<Appointment> appointments;
